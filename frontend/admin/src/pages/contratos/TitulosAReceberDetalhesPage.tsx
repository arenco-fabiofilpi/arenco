...
import { TituloAReceberDetalhesCard } from '../../components/TituloAReceberDetalhesCard'

export default function TitulosAReceberDetalhesPage() {
  ...
  useEffect(() => {
    ...
    apiClientes.get(`/clientes-api/v1/admin/a-receber?id=${id}`)
  ...
  return (
    <Box>
      ...
      {!loading && titulo && <TituloAReceberDetalhesCard titulo={titulo} />}
    </Box>
  )
}
