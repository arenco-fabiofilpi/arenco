...
public class GerarPdfBoletoStrategyImpl extends AbstractGerarBoletoStrategyImpl {
  ...
  public void gerar(
    ...
    try {
      final var bytes = pdfGerado.geraPDF();
      uploadFromBytes(model.getId(), bytes, "application/pdf");
